...
export const SYSTEMSTRACT = [
  {
    ...
    listOption: [
      ...
      { name: 'מטלות חוץ בסיס (שמירה/ הגנ"ש/ עבודות רס"ר / אחר)', value: "home", y: 12 },
  ...
  },
  {
    ...
    listOption: [
      ...
      { name: "התארגנות (בוקר,זמן תפילה,נקנ''ש ,שעת ת''ש)", value: "base", y: 20 },
      ...
      { name: "למידה עצמית והשלמות תכנים (ל''ע/ע''ע)", value: "base", y: 5 },
      { name: "מבחן (מעשי/עיוני)", value: "base", y: 5 },
      { name: "(מאמן) סימולטור", value: "base", y: 20 },
      { name: "שיחות וסיכומים (אישי/ציוותי/פלוגתי)", value: "base", y: 5 },
      { name: "מטלות בסיס (שמירה /מטבח/הגנ''ש/עבודות רס''ר)", value: "base", y: 5 },
      { name: "הגעה לבסיס", value: "base", y: 20 },
    ],
  },
  {
    y: 30,
    ...
    listOption: [
      { name: "נסיעות (ירידה לשטח)", value: "area", y: 5 },
      { name: "שינה בשטח", value: "area", y: 10 },
      { name: "מסדרים", value: "area", y: 5 },
      { name: "התארגנות (בוקר,זמן תפילה,נקנ''ש ,שעת ת''ש)", value: "area", y: 30 },
      { name: "(כולל בחנים) אימון גופני", value: "area", y: 10 },
      { name: "הפסקת אוכל", value: "area", y: 10 },
      { name: "הפסקה", value: "area", y: 10 },
      { name: "משטח (טיפולים ותרגולים במשטח)", value: "area", y: 10 },
      { name: "תרגיל", value: "area", y: 5 },
      { name: "מטווחים", value: "area", y: 10 },
      { name: "למידה עצמית והשלמות תכנים (ל''ע/ע''ע)", value: "base", y: 5 },
      { name: "מבחן (מעשי/עיוני)", value: "base", y: 5 },
      { name: "שיחות וסיכומים (אישי/ציוותי/פלוגתי)", value: "base", y: 5 },
      { name: "מטלות בשטח (שמירה/ הקמות /עבודות רס''ר)", value: "base", y: 5 },
    ],
  },
];
