...
const CustomSelect = ({ options, placeholder, labelText, setState, keyToUpdate }) => {
    ...
    return (
        <div className="relative w-64 mt-5" ref={selectRef}>
            <label
            ...
            <div
                tabIndex={0}
                className={`border border-gray-300 rounded-md p-2 cursor-pointer bg-light_primary dark:bg-dark_primary text-light_primary_content dark:text-dark_primary_content ${isOpen && "border-2 border-blue-400"}`}
